        ...
        <div className="space-y-4 text-sm font-mono text-gray-800">
          ...
          {data.description && (
            <div className="flex items-start gap-4">
              <span className="font-semibold text-gray-700 w-32 shrink-0">Description:</span>
              <p className="flex-1 min-w-0 break-words text-gray-600 leading-relaxed">{data.description}</p>
            </div>
          )}
        </div>
      ) : (
