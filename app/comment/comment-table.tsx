...
export default function BlogTable() {
    const [data] = useState<BlogPost[]>([
        { id: "1", username: "John Doe", blogtitle: "Getting Started with Next.js", comment: "Great post!", createdAt: "2026-07-01", status: "pending" },
        { id: "2", username: "Jane Smith", blogtitle: "Advanced React Patterns", comment: "Excellent insights!", createdAt: "2026-07-02", status: "approved" },
        { id: "3", username: "Mike Johnson", blogtitle: "Understanding TypeScript", comment: "Very informative!", createdAt: "2026-07-03", status: "pending" },
        { id: "4", username: "Sarah Williams", blogtitle: "Design Systems in 2026", comment: "Love the examples!", createdAt: "2026-07-04", status: "approved" },
    ]);
        ...
        { accessorKey: "status", header: "Status" },
        {
            ...
            cell: () => (
                <div className="flex justify-center items-center">
                    <button type="button" className="text-blue-600 hover:scale-110 transition-transform">
                        <Eye size={15} />
                    </button>
                </div>
            ),
