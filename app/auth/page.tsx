...
export default function AuthPage() {
	return (
		<main
			className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-12 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700"
			style={{
				backgroundImage:
		...
		>
			...
			<div className="pointer-events-none absolute -right-32 top-1/4 w-[28rem] h-[28rem] bg-cyan-400/30 rounded-full blur-3xl" />
